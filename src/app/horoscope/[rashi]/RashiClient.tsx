...
import { Sparkles, ArrowLeft, Calendar, Flame, Droplets, Wind, Mountain } from 'lucide-react';

// Rashi metadata
export const rashiMetadata: Record<string, { nameEn: string; nameHi: string; icon: string; element: string }> = {
...
export default function RashiClient({ rashiId }: { rashiId: string }) {
    ...
    const rashiInfo = rashiMetadata[rashiId.toLowerCase()];
