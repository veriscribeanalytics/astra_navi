                        ...
                        {viewMode === 'rashi' && (
                            ...
                            >
                                {/* <div className="flex items-center justify-between mb-1 px-1">
                                    <button 
                                        onClick={() => setViewMode('encyclopedia')}
                                        className="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-foreground/40 hover:text-secondary transition-colors"
                                    >
                                        <ArrowLeft className="w-3 h-3" /> Back to Intro
                                    </button>
                                </div> */}

                                {/* 50:50 Dual Pane using standard Card */}
