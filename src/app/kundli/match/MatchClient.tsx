  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      ...
      <div className="flex justify-center mb-10">
        <div className="inline-flex p-1 bg-surface/40 backdrop-blur-xl border border-outline-variant/10 rounded-2xl">
          <button
        ...
        {activeTab === 'match' ? (
          <motion.div key="match-tab" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            {phase === 'result' && matchResult && (
              <motion.div key="result" initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="space-y-10">
