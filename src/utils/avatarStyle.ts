import { Briefcase, Heart, Sparkles, Star, Telescope, Flower, Coins, Activity } from 'lucide-react';
...
const AVATAR_ACCENT_MAP: Record<string, string> = {
  ...
  spiritual_guide: 'text-teal-400 bg-teal-500/10 border-teal-500/30',
...
const AVATAR_THEME_MAP: Record<string, AvatarTheme> = {
  ...
  spiritual_guide:     { secondary: '#14b8a6', glowColor: 'rgba(20,184,166,0.35)',  flareGold: '#5eead4' },
