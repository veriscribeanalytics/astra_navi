...
const Services = () => {
    ...
    return (
        <section className="px-4 sm:px-6 md:px-8 lg:px-12 w-full max-w-7xl mx-auto">
            {/* Header */}
            <div className="flex flex-row justify-between items-end mb-3 sm:mb-4 md:mb-5">
                <div>
            ...
            <div className="relative group">
                <div className="overflow-x-auto hide-scrollbar pb-4 -mx-4 px-4 sm:-mx-6 sm:px-6 md:-mx-8 md:px-8">
                    <motion.div 
                        ...
                        className="flex lg:grid lg:grid-cols-6 gap-3 sm:gap-4 md:gap-5 lg:gap-6 min-w-max lg:min-w-0 h-full"
                    >
