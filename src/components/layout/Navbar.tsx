        ...
        return [
            {
                ...
                items: [
                    ...
                    { 
                        ...
                        desc: "Review compatibility for your saved charts."
                    },
                ]
            },
            {
                ...
                items: [
                    ...
                    { 
                        label: "Astro Analysis", 
                        href: "/ai-astro", 
                        icon: <Sparkles className="w-4 h-4" />,
                        desc: "Deep-dive reports generated by AI."
                    },
                    { 
                        label: "Chat Archives", 
                        href: "/archives", 
                        icon: <History className="w-4 h-4" />,
                        desc: "Search through your past sessions."
                    },
                ]
            },
            {
        ...
        },
        {
            ...
            items: [
                ...
                { 
                    ...
                    href: "/matching", 
                    icon: <Heart className="w-4 h-4" />,
                    desc: "Vedic compatibility for soul partners."
                },
                { 
                    label: "Gemstone Shop", 
                    href: "/shop", 
